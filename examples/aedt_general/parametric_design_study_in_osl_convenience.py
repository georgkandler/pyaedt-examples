...
NG_MODE = False #True  # HFSS jobs run non-graphically (headless) to support parallel execution.
MAX_PARALLEL_SOLVE_PROCESSES = 3
FORCE_SEQUENTIAL_SOLVE = True   # Set to True to force sequential execution even outside of Jupyter, for testing and debugging.
...
if __name__ == "__main__":
    ...
    print_designs(optimization_study.get_result_designs())
...
# +
if __name__ == "__main__":
    sorted_result_designs = sort_designs_by_id(optimization_study.get_result_designs())
    ...
    plt.scatter(
        ...
        marker="o",color="red", label="Pareto designs"
        )    
